...
RUN pip install --no-cache-dir --upgrade -r /home/trending/requirements.txt \
    && pip install trendspy justext text2emotion pymupdf4llm instabot python-multipart lighthouse-python-plus sqlalchemy yake fastapi_versioning tls_client spacy-layout uvicorn gnews \
